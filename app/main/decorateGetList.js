...
function decorateGetList(WrappedComponent, getListApi, params) {
    class DecorateGetList extends PureComponent {
        ...
        getNewer(params = {}) {
            ...
            this.startGettingList('newer', getListApi(params, this.getNewerSuccess, this.getNewerFailure))
        }
        ...
        getOlder(params = {}) {
            ...
            this.startGettingList('older', getListApi(params, this.getOlderSuccess, this.getOlderFailure))
        }
        ...
        getOlderSuccess(response) {
            ...
            const {items} = data;
            debugger
            this.setState(preState => ({data: preState.data.concat(items), page: preState.page + 1, loadingOlder: false}));
        }
        ...
        render() {
            const {loadingOlder, loadingNewer, loadingFirst, data, page, numberPage} = this.state;
            return (
                <WrappedComponent
                    data={data}
